...
const DataUser = () => {
  ...
  const getUsersID = async (value) => {
    const response = await axios.get("http://localhost:1000/users/" + value);
  ...
  const deleteUsersID = async (value) => {
    const response = await axios.delete("http://localhost:1000/users/" + value);
    console.log(response.data);
  ...
  const editUsersID = async (value, data) => {
    const response = await axios.patch(
      "http://localhost:1000/users/" + value,
      data
    );
